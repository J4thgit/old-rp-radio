Citizen.CreateThread(function()
	...
	Radio.Labels = {        
		{ "FRZL_RADIO_HELP", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " pour ~r~fermer ~s~le menu~n~~" .. radioConfig.Controls.Toggle.Name .. "~ pour ~r~allumer ~s~la radio~n~~" .. radioConfig.Controls.Decrease.Name .. "~ ou ~" .. radioConfig.Controls.Increase.Name .. "~ pour ~r~changer ~s~de fréquence~n~~" .. radioConfig.Controls.Input.Name .. "~ pour ~r~choisir ~s~une fréquence~n~~" .. radioConfig.Controls.ToggleClicks.Name .. "~ pour ~r~~a~ ~s~les clics de radio~n~Fréquence choisie: ~r~~1~ MHz" },
		{ "FRZL_RADIO_HELP2", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " pour ~r~fermer ~s~le menu~n~~" .. radioConfig.Controls.Toggle.Name .. "~ pour ~r~éteindre ~s~la radio~n~~" .. radioConfig.Controls.Broadcast.Name .. "~ pour ~r~parler ~s~à la radio~n~Fréquence choisie: ~r~~1~ MHz" },
		{ "FRZL_RADIO_INPUT", "Entrez une ~r~fréquence" },
	}
	...
	Citizen.CreateThread(function()
		...
		while true do
			...
			if Radio.On or Radio.Open then
			...
			if Radio.On or Radio.Open then
				ESX.TriggerServerCallback("rpradio:checkItem", function(verif)
					if not verif then
			...
			if Radio.Open then
				...
				if not Radio.On then
					AddTextComponentSubstringPlayerName(Radio.Clicks and "~r~désactiver~w~" or "~r~activer~w~")
				end
